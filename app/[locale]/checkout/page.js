...
export default function CheckoutPage({ params }) {
    ...
    const handleSubmit = async (e) => {
        ...
        // 1. Prepare WhatsApp Message URL (Keep existing logic)
        ...
        const phoneNumber = settings?.whatsapp_number || '6281234567890'; // Placeholder - replace with real number
        ...
        try {
            ...
            if (error) {
                alert('Connection error. Redirecting to WhatsApp directly.');
                window.open(waUrl, '_blank');
                setIsSubmitting(false);
                return;
            }

            // 3. Save WA Link to LocalStorage for the Success Page
            localStorage.setItem('pending_wa_link', waUrl);
                ...
                <div>
                    <div className="bg-gray-50 p-6 md:p-8 rounded-lg border border-gray-200 sticky top-[160px]">
                        ...
                        <button
                            ...
                            className="w-full bg-[#25D366] hover:bg-[#20bd5a] disabled:bg-gray-400 text-white font-bold py-4 rounded-lg shadow-md transition-all flex items-center justify-center gap-2 group"
                        >
                            {isSubmitting ? (
