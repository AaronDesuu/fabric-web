 ...
 * @param {string} currentId - ID of the current product to exclude
 * @param {string} category - Category to search for
 * @param {number} limit - Max number of related products (default 4)
 * @returns {Promise<Array>} Array of related products
 */
export async function getRelatedProducts(currentId, category, limit = 4) {
