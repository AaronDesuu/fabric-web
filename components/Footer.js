            ...
            <div className="max-w-container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col gap-2 text-center md:text-left">
                        ...
                        <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="text-gray-300 text-sm hover:text-white transition-colors flex items-center gap-2 justify-center md:justify-start">
